...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_10985 = 0;while(true){
if((i_10985 < arr.length))
{(arr[i_10985] = null);
{
...
{var i_10992 = (self__.level + 1);while(true){
if((i_10992 <= (new_level + 1)))
{(update[i_10992] = self__.header);
{
...
{var i_10994 = 0;while(true){
if((i_10994 <= self__.level))
{var links_10995 = (update[i_10994]).forward;if(((links_10995[i_10994]) === x__$1))
{(links_10995[i_10994] = (x__$1.forward[i_10994]));
{
var G__10996 = (i_10994 + 1);
i_10994 = G__10996;
continue;
}
} else
{{
var G__10997 = (i_10994 + 1);
i_10994 = G__10997;
continue;
}
}
