...
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t11014 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t11014');

/**
* @constructor
*/
cljs.core.async.impl.channels.t11014 = (function (val,box,meta11015){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t11014.cljs$lang$type = true;
cljs.core.async.impl.channels.t11014.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t11014";
cljs.core.async.impl.channels.t11014.cljs$lang$ctorPrWriter = (function (this__3410__auto__,writer__3411__auto__,opt__3412__auto__){return cljs.core._write.call(null,writer__3411__auto__,"cljs.core.async.impl.channels/t11014");
});
cljs.core.async.impl.channels.t11014.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t11014.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11016){var self__ = this;
return self__.meta11015;
});
cljs.core.async.impl.channels.t11014.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11016,meta11015__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t11014(self__.val,self__.box,meta11015__$1));
});
cljs.core.async.impl.channels.__GT_t11014 = (function __GT_t11014(val__$1,box__$1,meta11015){return (new cljs.core.async.impl.channels.t11014(val__$1,box__$1,meta11015));
});
}
return (new cljs.core.async.impl.channels.t11014(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_11017 = self__.takes.pop();if((taker_11017 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_11017))
{var take_cb_11018 = cljs.core.async.impl.protocols.commit.call(null,taker_11017);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_11018,taker_11017){
return (function (){return take_cb_11018.call(null,null);
});})(take_cb_11018,taker_11017))
);
} else
{}
{
