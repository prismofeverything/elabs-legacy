...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_11008 = 0;while(true){
var m_11009 = cljs.core.async.impl.dispatch.tasks.pop();if((m_11009 == null))
{} else
{m_11009.call(null);
if((count_11008 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__11010 = (count_11008 + 1);
count_11008 = G__11010;
continue;
}
} else
{}
