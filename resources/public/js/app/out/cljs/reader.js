...
reader_error.cljs$lang$applyTo = (function (arglist__9010){
var rdr = cljs.core.first(arglist__9010);
var msg = cljs.core.rest(arglist__9010);
...
{{
var G__9011 = (function (){sb.append(ch);
return sb;
})();
var G__9012 = cljs.reader.read_char.call(null,rdr);
sb = G__9011;
ch = G__9012;
continue;
}
...
{{
var G__9013 = cljs.reader.read_char.call(null,rdr);
ch = G__9013;
continue;
}
} else
...
var G__9014 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__9014;
continue;
}
} else
...
var G__9015 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__9015;
continue;
}
}
...
{{
var G__9016 = (function (){buffer.append(ch);
return buffer;
})();
var G__9017 = cljs.reader.read_char.call(null,reader);
buffer = G__9016;
ch = G__9017;
continue;
}
...
{if(("\\" === ch))
{{
var G__9018 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__9019 = cljs.reader.read_char.call(null,reader);
buffer = G__9018;
ch = G__9019;
continue;
}
...
{{
var G__9020 = (function (){buffer.append(ch);
return buffer;
})();
var G__9021 = cljs.reader.read_char.call(null,reader);
buffer = G__9020;
ch = G__9021;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__9023 = o;if(G__9023)
{if((function (){var or__3943__auto__ = (G__9023.cljs$lang$protocol_mask$partition0$ & 262144);if(or__3943__auto__)
{return or__3943__auto__;
} else
{return G__9023.cljs$core$IWithMeta$;
}
})())
{return true;
} else
{if((!G__9023.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IWithMeta,G__9023);
} else
{return false;
}
}
...
{{
var G__9024 = reader;
var G__9025 = eof_is_error;
var G__9026 = sentinel;
var G__9027 = is_recursive;
reader = G__9024;
eof_is_error = G__9025;
sentinel = G__9026;
is_recursive = G__9027;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__9028 = cljs.reader.read_comment.call(null,reader,ch);
var G__9029 = eof_is_error;
var G__9030 = sentinel;
var G__9031 = is_recursive;
reader = G__9028;
eof_is_error = G__9029;
sentinel = G__9030;
is_recursive = G__9031;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__9032 = reader;
var G__9033 = eof_is_error;
var G__9034 = sentinel;
var G__9035 = is_recursive;
reader = G__9032;
eof_is_error = G__9033;
sentinel = G__9034;
is_recursive = G__9035;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__9038 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__9038,0,null);var years = cljs.core.nth.call(null,vec__9038,1,null);var months = cljs.core.nth.call(null,vec__9038,2,null);var days = cljs.core.nth.call(null,vec__9038,3,null);var hours = cljs.core.nth.call(null,vec__9038,4,null);var minutes = cljs.core.nth.call(null,vec__9038,5,null);var seconds = cljs.core.nth.call(null,vec__9038,6,null);var fraction = cljs.core.nth.call(null,vec__9038,7,null);var offset_sign = cljs.core.nth.call(null,vec__9038,8,null);var offset_hours = cljs.core.nth.call(null,vec__9038,9,null);var offset_minutes = cljs.core.nth.call(null,vec__9038,10,null);var v = vec__9038;if(cljs.core.not.call(null,v))
...
{var vec__9040 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__9040,0,null);var months = cljs.core.nth.call(null,vec__9040,1,null);var days = cljs.core.nth.call(null,vec__9040,2,null);var hours = cljs.core.nth.call(null,vec__9040,3,null);var minutes = cljs.core.nth.call(null,vec__9040,4,null);var seconds = cljs.core.nth.call(null,vec__9040,5,null);var ms = cljs.core.nth.call(null,vec__9040,6,null);var offset = cljs.core.nth.call(null,vec__9040,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
