...
{{
var G__8407 = cljs.core.pop.call(null,v__$1);
v__$1 = G__8407;
continue;
}
} else
...
{var pred__8411 = cljs.core._EQ_;var expr__8412 = limit;if(pred__8411.call(null,1,expr__8412))
{return cljs.core.vector.call(null,s);
} else
{if(pred__8411.call(null,2,expr__8412))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__8414 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__8415 = (limit__$1 - 1);
var G__8416 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__8414;
limit__$1 = G__8415;
parts = G__8416;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___8418 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___8418))
{var replacement_8419 = temp__4090__auto___8418;buffer.append([cljs.core.str(replacement_8419)].join(''));
} else
{buffer.append(ch);
}
{
